...
void  MainWindow:: Print_wingsmech     ()
{
    ...
    ui->p130_11->setText("ГИДРОПИТАНИЕ = " + QString::number(uks_inst.P_130_11));
    ui->p130_12->setText("СЛЕДЯЩИЙ РЕЖИМ = " + QString::number(uks_inst.P_130_12));
    ui->p130_13->setText("ЗАКРЫЛКИ НЕВЗЛЕТ = " + QString::number(uks_inst.P_130_13));
    ui->p130_14->setText("ПРЕДКРЫЛКИ НЕВЗЛЕТ = " + QString::number(uks_inst.P_130_14));
    ui->p130_15->setText("Работа канала на выпуск закрылков = " + QString::number(uks_inst.P_130_15));
    ui->p130_16->setText("Работа канала на уборку закрылков = " + QString::number(uks_inst.P_130_16));
    ui->p130_17->setText("Работа канала на выпуск предкрылков = " + QString::number(uks_inst.P_130_17));
    ui->p130_18->setText("Работа канала на уборку предкрылков = " + QString::number(uks_inst.P_130_18));
    ui->p130_19->setText("РЕЗЕРВНЫЙ РЕЖИМ = " + QString::number(uks_inst.P_130_19));
    ui->p130_20->setText("ВЫПУСК ЗАКРЫЛКОВ В РЕЗЕРВНОМ РЕЖИМЕ = " + QString::number(uks_inst.P_130_20));
    ui->p130_21->setText("УБОРКА ЗАКРЫЛКОВ В РЕЗЕРВНОМ РЕЖИМЕ = " + QString::number(uks_inst.P_130_21));
    ui->p130_22->setText("ВЫПУСК ПРЕДКРЫЛКОВ В РЕЗЕРВНОМ РЕЖИМЕ = " + QString::number(uks_inst.P_130_22));
    ui->p130_23->setText("УБОРКА ПРЕДКРЫЛКОВ В РЕЗЕРВНОМ РЕЖИМЕ = " + QString::number(uks_inst.P_130_23));
    ui->p130_24->setText("Срабатывание тормоза левых закрылков = " + QString::number(uks_inst.P_130_24));
    ui->p130_25->setText("Срабатывание тормоза правых закрылков = " + QString::number(uks_inst.P_130_25));
