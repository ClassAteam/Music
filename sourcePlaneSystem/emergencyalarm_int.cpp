...
lights.append(new light(&bss_inst.BSS837X1z, (&pDev->OUT_D[2][20]), new bool{},
                            clrType::yellow, bssType::bss837));
//lights.append(new light(&bss_inst.BSS837X1p, (&pDev->OUT_D[2][33]), new bool{},
//                            clrType::yellow, bssType::bss837));
...
//                            clrType::yellow, bssType::bss926));
//    lights.append(new light(&bss_inst.BSS926X1x, (&pDev->OUT_D[2][24]), new bool{},
//                            clrType::yellow, bssType::bss926));
//    lights.append(new light(&bss_inst.BSS926X1BB, (&pDev->OUT_D[2][15]), new bool{},
//                            clrType::yellow, bssType::bss926));
//    lights.append(new light(&bss_inst.BSS926X1FF, (&pDev->OUT_D[2][17]), new bool{},
//                            clrType::yellow, bssType::bss926));
...
//                            clrType::white, bssType::bss926));
//    lights.append(new light(&bss_inst.BSS926X1z, (&pDev->OUT_D[2][13]), new bool{},
//                            clrType::white, bssType::bss926));
//    lights.append(new light(&bss_inst.BSS926X1DD, (&pDev->OUT_D[2][16]), new bool{},
//                            clrType::white, bssType::bss926));
//    lights.append(new light(&bss_inst.BSS926X1KK, (&bss_inst.BSS926X2f), new bool{},
//                            clrType::white, bssType::bss926));
//    lights.append(new light(&bss_inst.BSS926X1MM, (&pDev->OUT_D[2][11]), new bool{},
//                            clrType::white, bssType::bss926));
//    lights.append(new light(&bss_inst.BSS926X3A, (&bss_inst.BSS926X2h), new bool{},
//                            clrType::white, bssType::bss926));
//    lights.append(new light(&bss_inst.BSS926X3C, (&pDev->OUT_D[2][27]), new bool{},
//                            clrType::white, bssType::bss926));
//    lights.append(new light(&bss_inst.BSS926X3E, (&pDev->OUT_D[2][28]), new bool{},
//                            clrType::white, bssType::bss926));
//    lights.append(new light(&bss_inst.BSS926X3H, (&bss_inst.BSS926X2k), new bool{},
//                            clrType::white, bssType::bss926));
//    lights.append(new light(&bss_inst.BSS926X3J, (&pDev->OUT_D[2][21]), new bool{},
//                            clrType::white, bssType::bss926));
//    lights.append(new light(&bss_inst.BSS926X3L, (&pDev->OUT_D[2][24]), new bool{},
//                            clrType::white, bssType::bss926));
//    lights.append(new light(&bss_inst.BSS926X3N, (&pDev->OUT_D[2][36]), new bool{},
//                            clrType::white, bssType::bss926));
//    lights.append(new light(&bss_inst.BSS926X3R, (&pDev->OUT_D[2][54]), new bool{},
//                            clrType::white, bssType::bss926));
//    lights.append(new light(&bss_inst.BSS926X3T, (&pDev->OUT_D[2][55]), new bool{},
//                            clrType::white, bssType::bss926));
...
//                            clrType::yellow, bssType::bss837));
//    lights.append(new light(&bss_inst.BSS837X1J, (&pDev->OUT_D[2][5]), new bool{},
//                            clrType::yellow, bssType::bss837));
//    lights.append(new light(&bss_inst.BSS837X1N, (&pDev->OUT_D[2][9]), new bool{},
//                            clrType::yellow, bssType::bss837));
//    lights.append(new light(&bss_inst.BSS837X1R, (&pDev->OUT_D[2][6]), new bool{},
//                            clrType::yellow, bssType::bss837));
//    lights.append(new light(&bss_inst.BSS837X1V, (&pDev->OUT_D[2][10]), new bool{},
//                            clrType::yellow, bssType::bss837));
//    lights.append(new light(&bss_inst.BSS837X1L, (&pDev->OUT_D[2][7]), new bool{},
//                            clrType::yellow, bssType::bss837));
...
//                            clrType::yellow, bssType::bss837));
//    lights.append(new light(&bss_inst.BSS837X1b, (&pDev->OUT_D[2][30]), new bool{},
//                            clrType::yellow, bssType::bss837));
//    lights.append(new light(&bss_inst.BSS837X1d, (&pDev->OUT_D[2][32]), new bool{},
//                            clrType::yellow, bssType::bss837));
//    lights.append(new light(&bss_inst.BSS837X1f, (&pDev->OUT_D[2][31]), new bool{},
//                            clrType::yellow, bssType::bss837));
//    lights.append(new light(&bss_inst.BSS837X1h, (&pDev->OUT_D[2][35]), new bool{},
//                            clrType::yellow, bssType::bss837));
//    lights.append(new light(&bss_inst.BSS837X1j, (&pDev->OUT_D[2][25]), new bool{},
//                            clrType::yellow, bssType::bss837));
//    lights.append(new light(&bss_inst.BSS837X1r, (&pDev->OUT_D[2][34]), new bool{},
//                            clrType::yellow, bssType::bss837));
//    lights.append(new light(&bss_inst.BSS837X1t, (&pDev->OUT_D[2][22]), new bool{},
//                            clrType::yellow, bssType::bss837));
//    lights.append(new light(&bss_inst.BSS837X1x, (&pDev->OUT_D[2][19]), new bool{},
//                            clrType::yellow, bssType::bss837));
//    lights.append(new light(&bss_inst.BSS837X1BB, (&pDev->OUT_D[2][57]), new bool{},
//                            clrType::yellow, bssType::bss837));
//    lights.append(new light(&bss_inst.BSS837X1DD, (&pDev->OUT_D[2][58]), new bool{},
//                            clrType::yellow, bssType::bss837));
//    lights.append(new light(&bss_inst.BSS837X1KK, (&pDev->OUT_D[2][59]), new bool{},
//                            clrType::yellow, bssType::bss837));
//    lights.append(new light(&bss_inst.BSS837X1MM, (&pDev->OUT_D[2][52]), new bool{},
//                            clrType::yellow, bssType::bss837));
//    lights.append(new light(&bss_inst.BSS837X3G, (&pDev->OUT_D[2][59]), new bool{},
//                            clrType::yellow, bssType::bss837));
//    lights.append(new light(&bss_inst.BSS837X3J, (&pDev->OUT_D[2][46]), new bool{},
//                            clrType::yellow, bssType::bss837));

//    lights.append(new light(&bss_inst.BSS837X1p, (&pDev->OUT_D[2][32]), new bool{},
//                            clrType::red, bssType::bss837));
//    lights.append(new light(&bss_inst.BSS837X3C, (&pDev->OUT_D[2][50]), new bool{},
//                            clrType::red, bssType::bss837));
//    lights.append(new light(&bss_inst.BSS837X3N, (&pDev->OUT_D[2][48]), new bool{},
//                            clrType::red, bssType::bss837));

//    lights.append(new light(&bss_inst.BSS837X1T, (&bss_inst.BSS837X2J), new bool{},
//                            clrType::white, bssType::bss837));
//    lights.append(new light(&bss_inst.BSS837X1n, (&pDev->OUT_D[2][26]), new bool{},
//                            clrType::white, bssType::bss837));
//    lights.append(new light(&bss_inst.BSS837X1v, (&pDev->OUT_D[2][23]), new bool{},
//                            clrType::white, bssType::bss837));
//    lights.append(new light(&bss_inst.BSS837X1FF, (&pDev->OUT_D[2][56]), new bool{},
//                            clrType::white, bssType::bss837));
//    lights.append(new light(&bss_inst.BSS837X1HH, (&pDev->OUT_D[2][45]), new bool{},
//                            clrType::white, bssType::bss837));
//    lights.append(new light(&bss_inst.BSS837X3A, (&pDev->OUT_D[2][53]), new bool{},
//                            clrType::white, bssType::bss837));
//    lights.append(new light(&bss_inst.BSS837X3E, (&pDev->OUT_D[2][51]), new bool{},
//                            clrType::white, bssType::bss837));
//    lights.append(new light(&bss_inst.BSS837X3L, (&pDev->OUT_D[2][47]), new bool{},
//                            clrType::white, bssType::bss837));
//    lights.append(new light(&bss_inst.BSS837X3R, (&pDev->OUT_D[2][22]), new bool{},
//                            clrType::white, bssType::bss837));
//    lights.append(new light(&bss_inst.BSS837X3T, (&bss_inst.BSS837X2r), new bool{},
//                            clrType::white, bssType::bss837));
//    lights.append(new light(&bss_inst.BSS838X5A, (&pDev->OUT_D[2][37]), new bool{},
//                            clrType::yellow, bssType::bss838));
//    lights.append(new light(&bss_inst.BSS838X5J, &pDev->OUT_D[2][43], new bool{},
//                            clrType::yellow, bssType::bss838));
...
//    lights.append(new light(&bss_inst.BSS838X5E, &pDev->OUT_D[2][39], new bool{},
//                            clrType::red, bssType::bss838));
//    lights.append(new light(&bss_inst.BSS838X5N, &pDev->OUT_D[2][41], new bool{},
//                            clrType::red, bssType::bss838));
...
//    lights.append(new light(&bss_inst.BSS838X5C, &pDev->OUT_D[2][38], new bool{},
//                            clrType::white, bssType::bss838));
//    lights.append(new light(&bss_inst.BSS838X5G, &pDev->OUT_D[2][40], new bool{},
//                            clrType::white, bssType::bss838));
//    lights.append(new light(&bss_inst.BSS838X5L, &pDev->OUT_D[2][44], new bool{},
//                            clrType::white, bssType::bss838));
//    lights.append(new light(&bss_inst.BSS838X5R, &pDev->OUT_D[2][42], new bool{},
//                            clrType::white, bssType::bss838));
